...
to go
  ...
  let i 0
  while [i < nobs] [
    let x0 random-normal -1 5
    let x1 random-normal 1 4
    let x2 random-normal 2 3
    let x3 random-normal 4 2
  ...
  output-print stats:medians tbl
  output-print stats:means tbl
  output-print stats:stddevs tbl
  output-print median stats:get-observations tbl "v0"
  output-print mean stats:get-observations tbl "v0"
  output-print standard-deviation stats:get-observations tbl "v0"

  output-print ""
  output-print "covariances and correlations:"
  output-print stats:correlation tbl
  ...
  output-print stats:regress-all newtbl
  output-print stats:get-rstats newtbl
  output-print stats:get-rcstats newtbl
  output-print stats:regress-on newtbl [0 1 2]
  output-print stats:regress-on newtbl ["v0" "v1" "v2"]
  output-print stats:get-rstats newtbl
  output-print stats:get-rcstats newtbl
  ...
  output-print stats:binomial-coefficient 100 50
  output-print stats:binomial-probability 10 5 0.5
  ...
  let a 10
  output-print "gamma:"
  output-print stats:gamma a
  output-print ln stats:gamma a
